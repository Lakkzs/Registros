...
const seccion2 = require('../controllers/ctrl_seccion2.js')
...
router.get('/seccionDepartamentos', seccion.seccionDepartamentos)
router.get('/seccionDepartamentos/:id', seccion.seccionDepartamentos1)router.get('/altaDocumentos', altaDocumentos.altaDocumentos)
...
router.get('/info_Hobbies', info.infoHobbies)
//EXTRAS
